      ...
      <div className="flex">
        ...
        <div className="flex gap-4">
          <svg
            ...
            height="100"
            viewBox="0 0 50 50"
            className="h-12 w-12 fill-current text-teal-50 cursor-pointer hover:text-teal-500 hover:scale-110 transition-transform"
            onClick={() =>
              handleSocialMedia("https://linkedin.com/in/jeremia-axelano")
            }
          >
          ...
          <svg
            ...
            height="100"
            viewBox="0 0 50 50"
            className="h-12 w-12 fill-current text-teal-50 hover:text-teal-500 hover:scale-110 transition-transform"
            onClick={() => handleSocialMedia("https://github.com/AxelanO7")}
          >
